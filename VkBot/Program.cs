    ...
    public class Program
    {
        ...
        public static List<List<string>> Question = new List<List<string>>
        {
            ...
            //14
             ...
             //Второй тест
             //16
             new List<string>{ "Наше кредо — \n" +
                 "1. выполнять обещания\n" +
                 "2. делать вкусно\n" +
                 "3. неуважать гостей\n" +
                 "4. быстро выдавать заказы\n", "1"},
             //17
             new List<string>{ "2:\n" +
                 "1. 10 минут\n" +
                 "2. 15 минут\n" +
        ...
        public static List<Burger> Burgers = new List<Burger>
        {
             ...
             new Burger
            {
                ...
                FileNames = new List<string>
                {
                    "/app/photoburgers/гранд де люкс/1.png",
                    "/app/photoburgers/гранд де люкс/2.png",
                    "/app/photoburgers/гранд де люкс/3.png",
                    "/app/photoburgers/гранд де люкс/4.png",
                    "/app/photoburgers/гранд де люкс/5.png",
                    "/app/photoburgers/гранд де люкс/6.png",
                    "/app/photoburgers/гранд де люкс/7.png",
                    "/app/photoburgers/гранд де люкс/8.png",
                    "/app/photoburgers/гранд де люкс/9.png",
                    "/app/photoburgers/гранд де люкс/10.png",
                    "/app/photoburgers/гранд де люкс/11.png",
                    "/app/photoburgers/гранд де люкс/12.png",
